...
import (
	...
	"paperexperiment/evm/db/ethdb"
	"paperexperiment/evm/db/ethdb/leveldb"
	"paperexperiment/evm/db/ethdb/memorydb"
	"paperexperiment/evm/db/ethdb/pebble"
...
// Change Point
// NewLevelDBDatabase and NewPebbleDBDatabase function is located in go-ethereum/node/atabase.go, but we'll define it here for convenience.
