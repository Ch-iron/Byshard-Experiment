...
import (
	...
	"paperexperiment/evm/state/stateless"
	"paperexperiment/evm/state/tracing"
	"paperexperiment/evm/trie"
	"paperexperiment/evm/trie/trienode"
	"paperexperiment/evm/trie/utils"
	"paperexperiment/evm/types"
...
func (s *StateDB) removeStateObject(addr common.Address) {
...
func (s *StateDB) CreateTemporaryAccount(addr common.Address) {
	newObj := newObject(s, addr, nil)
	s.setStateObject(newObj)
}

func (s *StateDB) RemoveTemporaryAccount(addr common.Address) {
	s.removeStateObject(addr)
}
